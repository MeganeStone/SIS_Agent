...
def build_top_graph(dashscope_api_key,volc_api_key, workspace_dir=None, translate_source_dir=None, translate_output_dir=None):
    # 1. 创建两个 Agent 实例（注意节点名称要与 Command 中的 goto 一致）
    main_agent = create_tbox_agent(
        code_agent_node_name="code_agent",
        dashscope_api_key=dashscope_api_key,
        volc_api_key=volc_api_key,
        translate_source_dir=translate_source_dir,
